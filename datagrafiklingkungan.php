<?php  
	...
	$date5 = mysqli_query($konek, "SELECT waktu FROM data_table WHERE ID>='$ID_awal' and ID<='$ID_akhir' ORDER BY ID ASC");
	$date6 = mysqli_query($konek, "SELECT waktu FROM data_table WHERE ID>='$ID_awal' and ID<='$ID_akhir' ORDER BY ID ASC");
	...
	$noise= mysqli_query($konek, "SELECT noise FROM data_table WHERE ID>='$ID_awal' and ID<='$ID_akhir'ORDER BY ID ASC");
	$co_two= mysqli_query($konek, "SELECT codua FROM data_table WHERE ID>='$ID_awal' and ID<='$ID_akhir'ORDER BY ID ASC");
?>
...
<!-- Tampilan Grafik -->
	...
	<div class="kartu">	
		...
		<!-- gambar grafik -->
		<script type="text/javascript">
			var ctxL = document.getElementById("myChart5").getContext('2d');
			var myLineChart = new Chart(ctxL, {
			  type: 'line',
			  data: {
			    labels: ["Jan", "Feb", "Mar", "April", "May", "June", "July"],
	...
	<div class="kartu">	
		...
		<!-- gambar grafik -->
		<script type="text/javascript">
			var ctxL = document.getElementById("myChart6").getContext('2d');
			var myLineChart = new Chart(ctxL, {
			  type: 'line',
			  data: {
			    labels: ["Jan", "Feb", "Mar", "April", "May", "June", "July"],
	...
	<div class="kartu">	
		...
		<!-- gambar grafik -->
		<script type="text/javascript">
			var ctxL = document.getElementById("myChart7").getContext('2d');
			var myLineChart = new Chart(ctxL, {
			  type: 'line',
			  data: {
			    labels: ["Jan", "Feb", "Mar", "April", "May", "June", "July"],
	...
	<div class="kartu">	
		...
		<!-- gambar grafik -->
		<script type="text/javascript">
			var ctxL = document.getElementById("myChart8").getContext('2d');
			var myLineChart = new Chart(ctxL, {
			  type: 'line',
			  data: {
			    labels: ["Jan", "Feb", "Mar", "April", "May", "June", "July"],
	...
	<div class="kartu">	
		...
		<!-- gambar grafik -->
		<script type="text/javascript">
			var ctxL = document.getElementById("myChart9").getContext('2d');
			var myLineChart = new Chart(ctxL, {
			  type: 'line',
			  data: {
			    labels: ["Jan", "Feb", "Mar", "April", "May", "June", "July"],
